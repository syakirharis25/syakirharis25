...
- 🐈 About the question, "do I accept donation in the form of a living cat?", I do not accept any donation in the form of any cat, as I do not eat cat, and because currently I am using PayPal service, therefore I am only accepting donation in form of legal currencies as listed in the [PayPal Supported Currencies](https://developer.paypal.com/docs/reports/reference/paypal-supported-currencies/)
- 📰 For those who want to be a member of Muhammad Syakir bin Mohd Haris, you can subscribe to my [monthly newsletter](https://www.getrevue.co/profile/syakirharis25/members) 
